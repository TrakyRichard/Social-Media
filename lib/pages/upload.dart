...
class _UploadState extends State<Upload> {
        ...
        builder: (context) {
          return SimpleDialog(
            ...
            children: <Widget>[
              ...
              SimpleDialogOption(
                child: Text('Prendre une image dans la gallery'),
        ...
        children: <Widget>[
          ...
          Padding(padding: EdgeInsets.only(top: 20.0),
            child: RaisedButton(
              ...
              child: Text("Charger une Image", style: TextStyle(
                color: Colors.white,
                fontSize: 22.0,
              ),
              ),
  ...
  Scaffold buildUploadForm() {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Description du Post", style: TextStyle(
            color: Colors.black
        ),),
        actions: <Widget>[
          FlatButton(
  ...
  getUserLocation() async {
    ...
    String  formattedAddress = "${placemark.locality}, ${placemark.country}, ${placemark.subLocality}";
